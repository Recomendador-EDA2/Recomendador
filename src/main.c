...
int main(void)
{
    ...
    /* ── Vertices ── */
    int u1 = adicionar_vertice(&g, "u1", USUARIO);
    int u2 = adicionar_vertice(&g, "u2", USUARIO);
    int u3 = adicionar_vertice(&g, "u3", USUARIO);
    int t1 = adicionar_vertice(&g, "t1", TEXTO);
    int t2 = adicionar_vertice(&g, "t2", TEXTO);
    int t3 = adicionar_vertice(&g, "t3", TEXTO);
    int t4 = adicionar_vertice(&g, "t4", TEXTO);
    int t5 = adicionar_vertice(&g, "t5", TEXTO);
    ...
    definir_conteudo(&g, t1, /* Dom Casmurro — amor/tragedia */
    ...
    definir_conteudo(&g, t2, /* Memorias Postumas de Bras Cubas — amor/tragedia */
    ...
    definir_conteudo(&g, t3, /* Romeu e Julieta — amor/tragedia */
    ...
    definir_conteudo(&g, t4, /* A Ilha do Tesouro — aventura pura */
    ...
    definir_conteudo(&g, t5, /* O Conde de Monte Cristo — vinganca + amor (ponte) */
    ...
    (void)fi; (void)av; (void)ro; (void)th;
